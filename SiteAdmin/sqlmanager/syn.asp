...
<table width='100%' border='0' align='center' cellpadding='2' cellspacing='1' class='border'>
  <tr class='tdbg'>
    <td ><strong>管理导航：</strong><a href="default.asp">SQL数据库管理</a> | <a href="adddatabase.asp">手工添加SQL数据库</a> | <a href="../admin/HostChg.asp">业务过户 </a> | <a href="syn.asp">同步上级数据库 </a></td>
  </tr>
</table>
<br />
<div class="synbox">
<div id="synmsg"></div>
开始ID:<input type="text" name="databaseid" value="<%=databaseid%>"> <input type="button" value="开始同步" onclick="synvdatabase()">
<BR>
如要全部同步请将ID设置为0
</div>
</body>
