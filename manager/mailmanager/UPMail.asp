		  ...
		  <div class="manager-right-bg">
		        ...
		        <form name="form1" method="post" action="../config/up.asp">
                 <table class="manager-table">
                 					...
                 					<tbody>
                 					<tr>
                 					  <th align="right" class="tdbg">邮局域名：</th>
                 					  <td height="15" class="tdbg" align="left"><%=Rs("m_bindname")%></td>
                 					</tr>
                 					 <tr bgcolor="#FFFFFF" <%=trstr%>>
                                                       <th align="right" class="tdbg">升级方式<font color="#000000">：</font></th>
                 ...
                 <input id="updateType" name="updateType" type="radio" checked value="OldupdateType" onClick="dochangeType()">到期时间不变</td>
                 					...
                 					<tr>
                 					  <th height="26" align="right" class="tdbg"> 邮局原类型：</th>
                 					...
                 					%>
                 					<tr>
                 					  <th height="26" align="right" bgcolor="#FFFFFF" class="tdbg">邮箱数：</th>
                 					  <td height="26" align="left" bgcolor="#FFFFFF" class="tdbg"><%=m_mxuser%>个   升级到 <input name="userNum"  class="manager-input s-input" id="userNum" type="text" class="inputbox" size="5" value="<%=m_mxuser%>" onkeyup="javascript:getneedmoney()"></td>
                 					<tr>
                 					<tr>
                 					  <th height="26" align="right" bgcolor="#FFFFFF" class="tdbg">每个邮箱大小：</th>
                 					  <td height="26" align="left" bgcolor="#FFFFFF" class="tdbg"><%=formatSizeText(m_size/m_mxuser)%>个   升级到
                 					  <%
                 					...
                 					<tr>
                 					  <th height="26" align="right" bgcolor="#FFFFFF" class="tdbg">邮局新类型：</th>
                 ...
                 %>
									...
									<%End if%>
                 					...
                 					<tr>
                 					  <th height="26" align="right" bgcolor="#FFFFFF" class="tdbg">所需差价：</th>
                 					  <td height="26" align="left" bgcolor="#FFFFFF" class="tdbg">
                 					...
                 					<tr align="center">
                 					  <td height="1" colspan="2" class="tdbg">
                 						 <span id="loadspan" style="display:none"><img src="../images/load.gif" border=0><br>正在执行,请稍候..<br></span>
                 						  <INPUT NAME="C1" TYPE="button"class="manager-btn s-btn"  VALUE="　确定升级　" onClick="return dosub(this.form)">
