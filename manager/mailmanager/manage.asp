		  ...
		  <div class="manager-right-bg">
		   <form name=form1 action="<%=request("script_name")%>" method=post>
              <table class="manager-table">
                  <tr>
                    <th width="10%" class="Title">邮局域名:</th>
                    <td width="33%"><%=s_comment%></td>
                    <th width="16%" class="Title">密码:</th>
                    <td width="41%"><input type=text value="<%=s_ftppassword%>" name="p_pwd" class="manager-input s-input">
                      <input type="submit" value="修改密码" onclick="return changepwd(this.form)" class="manager-btn s-btn" >
                    </td>
                  </tr>
                  <tr>
                    <th class="Title">IP地址:</th>
                    <td><%=s_serverIP%></td>
                    <th class="Title">邮局型号:</th>
                    <td><%=s_ProductId%></td>
                  </tr>
                  <tr>
                    <th class="Title">购买时间:</th>
                    <td><%=s_buydate%></td>
                    <th class="Title">到期时间:</th>
                    <td><%=s_expiredate%></td>
                  </tr>
                  <tr>
                    <td  colspan=4 align="center"><input type="submit" value="进入高级管理" class="manager-btn s-btn" onclick="javascript:this.form.action='<%=manager_url%>mail/checklogin.asp';this.form.target='_blank';">
					 ...
					 <input type="button" value="一键升级到云邮局" onclick="upyun(this)"  class="manager-btn s-btn">
