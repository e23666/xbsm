                    ...
                    <tr> 
                      <td colspan="3" align="center" bgcolor="#FFFFFF"> <br>
                        ...
                        <table width="80%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr> 
                            <td> 
                              <p>本证书由中国互联网络信息中心CNNIC（China Internet Network Information 
                                Center）授权<%=companyname%>并由<%=companyname%>（ <%=replace(companynameurl,"http://","")%>）制作并颁发此证。<b><br>
                                <br>
                                证明</b>：<br>
                                <br>
                                <b>域名<font color="#FF0000"> <font face="Arial, Helvetica, sans-serif"><%= rs("strDomain") %></font> 
