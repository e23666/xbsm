    ...
    <div id="MainRight">
      <div class="new_right"> 
        ...
        <div class="main_table">
          <div class="tab">发票查询</div>
          <div class="table_out">
          
          
        
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolordark="#FFFFFF" class="border managetable tableheight">
<tr align="center" class='titletr'>
                                  <td width="8%" class="Title"><strong>编号</strong></td>
    <td width="11%" class="Title"><strong>发票抬头</strong></td>
    <td width="6%" class="Title"><strong>金额</strong></td>
    <td width="13%" class="Title"><strong>发票内容</strong></td>
    <td width="19%" class="Title"><strong>邮寄地址</strong></td>
    <td width="7%" class="Title"><strong>邮编</strong></td>
    <td width="12%" class="Title"><strong>收件人</strong></td>
    <td width="9%" class="Title"><strong>状态</strong></td>
    <td width="12%" class="Title"><strong>寄出日期</strong></td>
    <td width="3%" class="Title"><strong>删</strong></td>
</tr>
                                <%
do while not rs.eof
f_id=Rs("f_id")
