...
　　   }
	...
	if(confirm("您确认提交本次发票申请吗？ 本次将扣除邮寄费"+yf.toFixed(2)+"元，手续费"+fpsxf.toFixed(2)+"元，共计"+(yf+fpsxf).toFixed(2)+"元。"))
		 ...
		 <div id="SiteMapPath">
		  ...
		  <div class="manager-right-bg">
                 ...
                 function ftypechange(v)
                 {
					 ...
					 <tr>
						<th colspan="2">发票索取</th>
					 </tr>
                      <tr>
                        <td width="26%" height="35" align="right">发票类型：</td>

                        <td align="left"><input name="ftype" type="radio" value="0" checked="checked" onclick="ftypechange(this.value)" /> 增值税普通发票(小规模纳税人)  &nbsp;<input name="ftype" type="radio" value="1"  onclick="ftypechange(this.value)" />  增值税专用发票(一般纳税人)</td>
                      </tr>
                      <tr class="ptfp">
                                  ...
                                  **<br>
                                  (如公司名称、学校名称、组织机构等,不能填个人姓名） </td>
                                                          ...
                                                          <tr  class="ptfp">
                                                            ...
                                                            (请勿超过120个字)</td>
                                                            <td align="left" valign="center" ><textarea  class="manager-textarea" name="purpose" cols="26" readonly>网络服务费</textarea>
                                                            ** </td>
                                                            </tr>
                                                          <tr  class="ptfp">
														 ...
														 <tr  class="ptfp">
                                                            <td align="right" valign="center" class="tdbg">统一社会信用代码（或纳税识别号）:</td>
...
公司用户必须填写</td>
                                    ...
                                    <label style="display:none"><input name="sendtype" type="radio" id="radio" value="0" disabled="disabled">挂号<span id="pcost0"></span></label>
                                    <label style="display:none"><input type="radio" name="sendtype" id="radio2" value="3" >平信<span id="pcost3"></span></label>
                                    <label><input type="radio" name="sendtype" id="radio3" value="1" checked>快递<span id="pcost1"></span></label>
                                    <!--,<input type="radio" name="sendtype" id="radio4" value="2">快递到付<span id="pcost2"></span>--></td>
                                                          </tr>
                                                          <tr  class="ptfp">
                                                            <td colspan="2" align="center" class="tdbg">
                                                              <input type="submit" value=" 提 交 确 认 " name="submit" class="manager-btn s-btn">
                                                              <input type="reset" value=" 重 新 填 写 " name="reset" class="manager-btn s-btn">                                          </td>
                                                          </tr>
                                                          <tr  class="ptfp">
                                                            <td colspan="2" class="tdbg">
                    提示： 若有相关问题，请咨询我司财务部。</td>
                                                          </tr>
                                    
                      <tr  id="zzfp" style="display:none">
                        <td align="center" colspan=2 style="color:#F00; font-weight:bold; font-size:16px; line-height:300%">开增值税专用发票(一般纳税人)请联系管理员</td>
                      </tr>
                    </table>
