...
ACT=requesta("ACT")
if ACT="modi" then
	sql="select * from PreDomain where d_id="&domainid&" and username='"&session("user_name")&"'"
	...
	rs.close
	response.Write("<script>alert(""订单修改成功！"");location.href='modify.asp?id="&domainid&"'</script>")
	response.End()
end if
    ...
    <div id="MainRight">
      <div class="new_right"> 
        ...
        <div class="main_table">
          <div class="tab">编辑域名订单</div>
          <div class="table_out">
               <form name=domainreg action="<%=Request("script_name")%>" method=post>
                ...
                <tr> 
                  <td valign="top"> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td width="100%" height="2" bgcolor="#ccc"></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                ...
                <tr> 
                  <td valign="top"> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td width="22%" height="19">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              ...
                              <td width="76%" valign="bottom" class="DropShadow2"><b><font class="14pxfont" style="font-size:14px; color:#06F;">域名中文资料</font></b></td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr> 
                        <td height="2" colspan="2" bgcolor="#ccc"></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                      ...
                      <tr> 
                        <td width="22%" height="19">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td width="24%" align="center">&nbsp;</td>
                              <td width="76%" valign="bottom" class="DropShadow2"><b><font class="14pxfont" style="font-size:14px; color:#06F;">域名英文资料</font></b></td>
                            </tr>
                          </table>
                        </td>
