...
if(dialogFirst==true){
  ...
  temp_float+="</div>";
  temp_float+="<div id=\"callID\" style=\"display:none; text-align:center\">  				<div>正在执行...不要关闭或刷新页面</div><div><img src=\"/newimages/load.gif\" border=0></div></div>"
...
$("#floatBox .title h4").css("color","#fff");
