...
function setbuttonrangeval(osdate,data, flux) {
    $("#data_range").html("<input type=\"range\" name=\"data\" min=\"20\" max=\"1000\" step=\"10\" value=\""+data+"\" /><div style=\"float:left;display:inline;margin-top:7px\">GB</div>");
    ...
    $("#flux_range").html("<input type=\"range\" name=\"flux\" min=\"0\" max=\"200\" step=\"1\" value=\""+flux+"\" /><div style=\"float:left;display:inline;margin-top:7px\">Mbps</div>");
