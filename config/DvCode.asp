...
Const nCharMin = 4							' 产生的最小字符个数 (3)
Const nCharMax = 4							' 产生的最大字符个数 (4)
Const nSpaceX = 8								' 左右两边的空白宽度 (2)
Const nSpaceY = 8								' 上下两边的空白宽度 (2)
Const nImgWidth = 70						' 数据区宽度 (60)
Const nImgHeight = 20						' 数据区高度 (16)
